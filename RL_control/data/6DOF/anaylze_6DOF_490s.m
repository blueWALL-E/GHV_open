 ...
 * @LastEditTime: 2026-03-17 23:59:47
...
function plot_aero_ang( ...
    ...
    for k = 1:3
        ...
        h2 = plot(t, y_GS_neg(:, k), 'g:', 'LineWidth', 1.8, 'Marker', 'o', 'MarkerIndices', idx, 'MarkerSize', 5);
        h3 = plot(t, y_GS_pos(:, k), 'g-.', 'LineWidth', 1.8, 'Marker', 'x', 'MarkerIndices', idx, 'MarkerSize', 8);

        % ===== TD3：蓝色 =====
        h4 = plot(t, y_TD3_norm(:, k), 'b-', 'LineWidth', 1.8);
        h5 = plot(t, y_TD3_neg(:, k), 'b:', 'LineWidth', 1.8, 'Marker', 'o', 'MarkerIndices', idx, 'MarkerSize', 5);
        h6 = plot(t, y_TD3_pos(:, k), 'b-.', 'LineWidth', 1.8, 'Marker', 'x', 'MarkerIndices', idx, 'MarkerSize', 8);
...
function plot_additional_signals( ...
    ...
    for k = 1:3
        ...
        h2 = plot(t, y_GS_neg, 'g:', 'LineWidth', 1.8, 'Marker', 'o', 'MarkerIndices', idx, 'MarkerSize', 5);
        h3 = plot(t, y_GS_pos, 'g-.', 'LineWidth', 1.8, 'Marker', 'x', 'MarkerIndices', idx, 'MarkerSize', 8);

        % ===== TD3：蓝色 =====
        h4 = plot(t, y_TD3_norm, 'b-', 'LineWidth', 1.8);
        h5 = plot(t, y_TD3_neg, 'b:', 'LineWidth', 1.8, 'Marker', 'o', 'MarkerIndices', idx, 'MarkerSize', 5);
        h6 = plot(t, y_TD3_pos, 'b-.', 'LineWidth', 1.8, 'Marker', 'x', 'MarkerIndices', idx, 'MarkerSize', 8);
        ...
        if k == 3
            legend( ...
                [h1, h2, h3, h4, h5, h6], ...
                {'GS-normal', 'GS-negative', 'GS-positive', ...
                 'TD3-normal', 'TD3-negative', 'TD3-positive'}, ...
                'NumColumns', 6, ...
                'Location', 'southoutside', ...
                'FontSize', 11);
        end
...
function plot_trajectory_3d( ...
    ...
    % ===== GS：绿色 =====
    plot3(x_GS_norm, y_GS_norm, z_GS_norm, ...
        'g-', 'LineWidth', 2.2, ...
        'DisplayName', 'GS-normal');

    plot3(x_GS_neg, y_GS_neg, z_GS_neg, ...
        'g:', 'LineWidth', 1.8, ...
        'Marker', 'o', 'MarkerIndices', 1:2000:length(x_GS_neg), 'MarkerSize', 5, ...
        'DisplayName', 'GS-negative');

    plot3(x_GS_pos, y_GS_pos, z_GS_pos, ...
        'g-.', 'LineWidth', 2.0, ...
        'Marker', '^', 'MarkerIndices', 500:2000:length(x_GS_pos), 'MarkerSize', 5, ...
        'DisplayName', 'GS-positive');

    % ===== TD3：蓝色 =====
    plot3(x_TD3_norm, y_TD3_norm, z_TD3_norm, ...
        'b-', 'LineWidth', 2.2, ...
        'DisplayName', 'TD3-normal');

    plot3(x_TD3_neg, y_TD3_neg, z_TD3_neg, ...
        'b:', 'LineWidth', 1.8, ...
        'Marker', 's', 'MarkerIndices', 1000:2000:length(x_TD3_neg), 'MarkerSize', 5, ...
        'DisplayName', 'TD3-negative');

    plot3(x_TD3_pos, y_TD3_pos, z_TD3_pos, ...
        'b-.', 'LineWidth', 2.0, ...
        'Marker', 'd', 'MarkerIndices', 1500:2000:length(x_TD3_pos), 'MarkerSize', 5, ...
        'DisplayName', 'TD3-positive');
    % ===== 坐标轴 =====
