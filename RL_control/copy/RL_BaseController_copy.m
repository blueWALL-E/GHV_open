 ...
 * @LastEditTime: 2025-12-08 23:31:15
 * @FilePath: \GHV_open\RL_control\RL_BaseController_copy.m
...
% S          单位 n.d.  滑模面向量 3*1
function [LE, RE, RUD, d_rho_smc, S] = RL_BaseController_copy(dd_aero_ang_d, aero_ang_e, d_aero_ang_e, i_aero_ang_e, rho_smc, t)
    %输出变量初始化
