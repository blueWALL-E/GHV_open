 ...
 * @LastEditTime: 2026-05-18 22:30:43
 * @FilePath: \GHV_open\Control_Schemes\GHV_control_parameter_optimization\adaptive_sliding_mode_controller.m
...
% S          单位 n.d.  滑模面向量 3*1
function [LE, RE, RUD, d_rho_smc, S] = adaptive_sliding_mode_controller(dd_aero_ang_d, aero_ang_e, d_aero_ang_e, i_aero_ang_e, rho_smc, control_param_alpha, control_param_bate, control_param_mu)
    %输出变量初始化
    d_rho_smc = zeros(3, 1);
    S = zeros(3, 1);
    %输入变量赋值
