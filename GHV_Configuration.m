 ...
 * @LastEditTime: 2026-02-04 21:51:18
...
GHV_cfg.mass_full = 129231.602; %单位 kg 飞行器最大质量136077kg 60s 6度攻角满功率爬升后滑翔质量 129273.68kg 129231.602kg
GHV_cfg.Ix = -7.10e-5 * GHV_cfg.mass_full ^ 2 + 19.910 * GHV_cfg.mass_full -5.943e4; %单位 kg*m^2 机体x轴的转动惯量
GHV_cfg.Iy = -8.03e-4 * GHV_cfg.mass_full ^ 2 + 219.74 * GHV_cfg.mass_full -1.690e6; %单位 kg*m^2 机体x轴的转动惯量
GHV_cfg.Iz = -8.03e-4 * GHV_cfg.mass_full ^ 2 + 219.74 * GHV_cfg.mass_full -1.690e6; %单位 kg*m^2 机体x轴的转动惯量
...
alpha = deg2rad(4.08); %初始攻角 输入单位 deg 4
