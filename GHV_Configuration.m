 ...
 * @LastEditTime: 2025-05-23 22:47:38
...
b_ref = 18.29; %机翼翼展 单位 m
c_ref = 24.38; %平均几何弦长 单位 m
s_ref = 334.73; %机翼参考面积 单位 m2
x_cg = 2.9; %单位 m 力矩中心到质心的距离
mass_full = 136077; %单位 kg 飞行器最大质量
Jx = 1.36 * 10 ^ 6; %单位 kg*m^2 机体x轴的转动惯量
Jy = 1.5 * 10 ^ 7; %单位 kg*m^2 机体x轴的转动惯量
Jz = 1.36 * 10 ^ 7; %单位 kg*m^2 机体x轴的转动惯量

%飞行器初始位置
xme_0 = [0; 0; -10000]; % Initial Position
Aimpoint = 0;
